...
Code files: 
1. Research & Zagat scraping: research notes and syntax used in scraping ratings data from Zagat
2. Scraping Michelin: code used to scrape Michelin restaurant names from the Michelin website
3. Cleaning Zagat data: code used to clean the Zagat data
